...
// This benchmark is taken directly from `pg` package repository.
// Set `BENCH=true` env variable to enable instrumentation.
const WITH_SENTRY = process.env.BENCH;
